...
const StepOnePreSalePurchase = () => {
  ...
  const [expandedSubSteps, setExpandedSubSteps] = useState<boolean[]>(
    Array(subStepsOneSelling.length).fill(false)
  );
...
export default StepOnePreSalePurchase;
