    ...
    <>
      ...
      <ScrollView className="flex-1 bg-white">
        ...
        <StepOnePrePurchasing
          goToNextStep={() => goToNextStep("StepTwoPrePurchasing")}
        />
        <StepTwoUnderstandingMarketCondition
          goToNextStep={() => goToNextStep("StepThreeFindingAHome")}
        />
        <StepThreeFindingAHome
          goToNextStep={() => goToNextStep("StepFourMakingAnOfferr")}
        />
        <StepFourMakingAnOffer
          goToNextStep={() => goToNextStep("StepFivePostPurchase")}
        />
        <StepFivePostPurchase
          goToNextStep={() => goToNextStep("StepOnePrePurchasing")}
        />
      </ScrollView>
    </>
  );
