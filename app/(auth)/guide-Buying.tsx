...
const StepOnePrePurchasing = () => {
  ...
  const [expandedSubSteps, setExpandedSubSteps] = useState<boolean[]>(
    Array(subStepsOne.length).fill(false)
  );
    ...
    bullets: [
      {
        ...
        detail:
          "Check websites like Zillow, Realtor.com, and local real estate listings.",
      ...
      },
      {
        ...
        detail:
          "Compare different areas to determine where you can get the most value.",
      },
    ],
  },
  {
    ...
    bullets: [
      ...
      },
      {
        ...
        detail:
          "These can include taxes, incentives for homebuyers, and zoning laws.",
      },
    ],
  },
  {
    ...
    bullets: [
      ...
      },
      {
        ...
        detail:
          "Inventory often rises in spring and summer and falls in fall and winter.",
  ...
  const questionsStepTwo: Question[] = [
    {
      ...
      options: [
        "A) High demand and low inventory",
        "B) Decreasing home prices",
        "C) Multiple offers on properties",
        "D) Rapid sales",
      ],
      correctAnswer: "B) Decreasing home prices",
      correctExplanation:
        "Correct! A buyer's market is typically characterized by decreasing home prices due to higher inventory and lower demand.",
      incorrectExplanation:
        "Not quite. A buyer's market usually features decreasing home prices, as demand is lower than supply.",
    },
    {
      text: "How can you assess whether it's a good time to buy a home?",
      options: [
        "A) Check current mortgage rates",
        "B) Analyze local job market trends",
        "C) Monitor the housing inventory in your area",
        "D) All of the above",
      ],
      correctAnswer: "D) All of the above",
      correctExplanation:
        "Exactly! All these factors can indicate whether it’s a favorable time to buy a home.",
      incorrectExplanation:
        "Actually, you should consider all of these factors to determine if it's a good time to buy.",
    },
    {
      text: "What role does the local economy play in the housing market?",
      options: [
        "A) It has no impact",
        "B) It influences home prices and demand",
        "C) It only affects rental prices",
        "D) It’s only important for commercial real estate",
      ],
      correctAnswer: "B) It influences home prices and demand",
      correctExplanation:
        "Correct! The local economy directly impacts job stability and income levels, affecting housing demand and prices.",
      incorrectExplanation:
        "Not quite. The local economy significantly influences home prices and demand in the housing market.",
    },
  ];
  ...
  return (
    ...
    <View className="flex-1 bg-white p-4">
      ...
      {showQuestion && (
        <View className="mt-4">
          <Text className="font-bold text-lg">
            {questionsStepTwo[currentQuestionIndex].text}
          </Text>
          {questionsStepTwo[currentQuestionIndex].options.map((option) => (
            <TouchableOpacity
              ...
              onPress={() =>
                handleOptionSelect(
                  option,
                  questionsStepTwo[currentQuestionIndex]
                )
              }
              className={`p-2 rounded-lg mt-2 ${
                selectedOption === option
    ...
    bullets: [
      {
        ...
        detail:
          "This document outlines the final terms of your loan and closing costs.",
        resource: "https://www.consumerfinance.gov",
      },
      {
        text: "Schedule a final walkthrough of the property.",
        detail:
          "Ensure the home is in the agreed-upon condition before closing.",
        resource: "https://www.realtor.com",
      },
      {
        text: "Secure homeowners insurance and provide proof to your lender.",
        detail:
          "This protects your investment and is required by most lenders.",
        resource: "https://www.nolo.com",
      },
      {
        text: "Prepare funds for closing costs.",
        detail:
          "Ensure you have the down payment and any additional closing costs ready to go.",
        resource: "https://www.hud.gov",
      },
      {
  ...
  },
  {
    ...
    bullets: [
      ...
      },
      {
        ...
        detail:
          "Ask questions if you do not understand any part of the paperwork.",
        resource: "https://www.consumerfinance.gov",
      },
      {
      ...
      {
        text: "Receive the keys to your new home!",
        detail: "Congratulations on becoming a homeowner!",
      },
    ],
  },
  {
  ...
  const questionsStepFive: Question[] = [
    {
      ...
      options: [
        "A) A document detailing the home’s history",
        "B) A summary of the final loan terms and closing costs",
        "C) A form to apply for a mortgage",
        "D) An inspection report",
      ],
      correctAnswer: "B) A summary of the final loan terms and closing costs",
      correctExplanation:
        "Correct! The closing disclosure provides detailed information about the mortgage and associated costs.",
      incorrectExplanation:
        "Not quite. A closing disclosure summarizes the final loan terms and closing costs associated with your mortgage.",
    },
    {
      text: "What should you do after closing on your new home?",
      options: [
        "A) Immediately start renovations",
        "B) Change the locks",
        "C) Ignore the neighborhood",
        "D) Begin looking for a new home",
      ],
      correctAnswer: "B) Change the locks",
      correctExplanation:
        "Exactly! Changing the locks is a wise security measure after closing on your new home.",
      incorrectExplanation:
        "Actually, changing the locks is one of the first things you should do for your safety after closing.",
    },
    {
      text: "What is the purpose of a home warranty?",
      options: [
        "A) To cover all repair costs",
        "B) To provide protection for major home systems and appliances",
        "C) To ensure property value increases",
        "D) To cover moving expenses",
      ],
      correctAnswer:
        "B) To provide protection for major home systems and appliances",
      correctExplanation:
        "Correct! A home warranty protects against repairs on essential home systems and appliances after purchase.",
      incorrectExplanation:
        "Not quite. A home warranty is meant to protect you from unexpected repair costs for major home systems and appliances.",
    },
  ];
  ...
  return (
    ...
    <View className="flex-1 bg-white p-4">
      ...
      {showQuestion && (
        <View className="mt-4">
          <Text className="font-bold text-lg">
            {questionsStepFive[currentQuestionIndex].text}
          </Text>
          {questionsStepFive[currentQuestionIndex].options.map((option) => (
            <TouchableOpacity
              ...
              onPress={() =>
                handleOptionSelect(
                  option,
                  questionsStepFive[currentQuestionIndex]
                )
              }
              className={`p-2 rounded-lg mt-2 ${
                selectedOption === option
