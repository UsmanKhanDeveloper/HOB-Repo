...
const subStepsOne = [
    {
        ...
        bullets: [
            { text: "Create a Budget", detail: "Establish a clear monthly budget to track your income and expenses.", resource: "https://www.mint.com" },
            { text: "Calculate Debt-to-Income Ratio", detail: "Analyze your total monthly debt payments compared to your gross monthly income.", resource: "https://www.calculator.net/debt-to-income-ratio-calculator.html" },
            { text: "Identify Other Income Sources", detail: "Include any additional income sources such as bonuses, freelance work, or rental income." }
        ]
    },
    {
        title: "b) Understand Your Credit Score",
        bullets: [
            { text: "Check Your Credit Report", detail: "Obtain a free copy of your credit report from annualcreditreport.com to review your credit history.", resource: "https://www.annualcreditreport.com" },
            { text: "Improve Your Credit Score", detail: "Learn ways to improve your credit score before applying for a mortgage.", resource: "https://www.experian.com/blogs/news/2020/07/how-to-improve-your-credit-score/" },
            { text: "Understand Credit Scoring Models", detail: "Familiarize yourself with the different scoring models (FICO, VantageScore) and what factors contribute to your score." }
        ]
    },
    {
        title: "c) Save for a Down Payment",
        bullets: [
            { text: "Determine Down Payment Percentage", detail: "Research typical down payment percentages required for different types of loans.", resource: "https://www.hud.gov/topics/down_payment_assistance" },
            { text: "Explore Down Payment Assistance", detail: "Look into programs that provide financial assistance for down payments." },
            { text: "Set Up a Dedicated Savings Account", detail: "Open a separate savings account specifically for your down payment." }
        ]
    },
    {
        title: "d) Get Pre-Approved for a Mortgage",
        bullets: [
            { text: "Research Lenders", detail: "Compare mortgage lenders to find the best rates and terms for your situation.", resource: "https://www.bankrate.com/mortgages/lender-reviews/" },
            { text: "Gather Necessary Documents", detail: "Prepare your financial documents to streamline the pre-approval process." },
            { text: "Understand Pre-Approval vs. Pre-Qualification", detail: "Learn the difference between pre-approval and pre-qualification." }
        ]
    },
    {
        title: "e) Determine Your Budget for a Home",
        bullets: [
            { text: "Consider All Associated Costs", detail: "Factor in not just the purchase price, but also closing costs, property taxes, and maintenance." },
            { text: "Use Mortgage Calculators", detail: "Utilize online mortgage calculators to estimate your monthly payments.", resource: "https://www.mortgagecalculator.net" }
        ]
    },
];
...
const StepOnePrePurchasing = () => {
    ...
    return (
        ...
        <View className="flex-1 bg-white p-4">
            <TouchableOpacity onPress={handleExpand} className="bg-blue-100 p-4 rounded-lg flex-row items-center justify-center mb-2">
                ...
                <View className="bg-gray-200 p-4 rounded-lg">
                    <FlatList
                        ...
                        renderItem={({ item, index }) => (
                            <View className="mb-4">
                                <TouchableOpacity onPress={() => handleSubStepExpand(index)} className="flex-row items-center justify-between bg-gray-300 p-3 rounded-lg">
...
const subStepsTwo = [
    {
        ...
        bullets: [
            { text: 'Look into recent sales in your desired neighborhoods.', detail: 'Check websites like Zillow, Realtor.com, and local real estate listings.', resource: 'https://www.zillow.com' },
            { text: 'Observe the average days on market for homes.', detail: 'This indicates how quickly homes are selling in the area.' },
            { text: 'Analyze the price per square foot in different neighborhoods.', detail: 'Compare different areas to determine where you can get the most value.' },
        ]
    },
    {
        title: 'Understand Economic Indicators',
        bullets: [
            { text: 'Review interest rates and how they affect purchasing power.', detail: 'Lower rates can make buying a home more affordable.', resource: 'https://www.realtor.com' },
            { text: 'Follow job growth and unemployment rates in your area.', detail: 'These can influence housing demand and prices.' },
            { text: 'Consider local government policies affecting real estate.', detail: 'These can include taxes, incentives for homebuyers, and zoning laws.' },
        ]
    },
    {
        title: 'Analyze Housing Inventory',
        bullets: [
            { text: 'Evaluate the number of homes available for sale.', detail: 'A low inventory can lead to competitive bidding situations.' },
            { text: 'Look into the types of homes available: new builds vs. resales.', detail: 'Each has different pros and cons regarding price and upkeep.' },
            { text: 'Understand seasonal trends in housing inventory.', detail: 'Inventory often rises in spring and summer and falls in fall and winter.', resource: 'https://www.hud.gov' },
        ]
    },
];
...
const subStepsThree = [
    {
        ...
        bullets: [
            { text: 'Determine the number of bedrooms and bathrooms you need.', detail: 'Consider your current lifestyle and future plans.' },
            { text: 'Decide on must-have features, such as a backyard or garage.', detail: 'Make a list of priorities to guide your search.' },
            { text: 'Choose your preferred neighborhoods based on your research.', detail: 'Consider factors like schools, safety, and amenities.', resource: 'https://www.trulia.com' },
        ]
    },
    {
        title: 'Use Real Estate Platforms',
        bullets: [
            { text: 'Search listings on websites like Zillow, Realtor.com, or local MLS.', detail: 'Set alerts for new listings that meet your criteria.' },
            { text: 'Explore virtual tours to narrow down options.', detail: 'This saves time before visiting in person.', resource: 'https://www.redfin.com' },
            { text: 'Utilize apps that allow you to filter homes based on your preferences.', detail: 'This can streamline your search process.' },
        ]
    },
    {
        title: 'Engage a Real Estate Agent',
        bullets: [
            { text: 'Find an experienced agent familiar with your target area.', detail: 'They can provide valuable insights and access to listings.', resource: 'https://www.nar.realtor' },
            { text: 'Discuss your criteria and budget with your agent.', detail: 'This will help them tailor their search to your needs.' },
            { text: 'Attend open houses with your agent to view homes.', detail: 'They can guide you through the process and answer questions.' },
        ]
    },
];
...
const subStepsFour = [
    {
        ...
        bullets: [
            { text: 'Review the purchase agreement with your real estate agent.', detail: 'Understand the terms and conditions before signing.' },
            { text: 'Prepare an earnest money deposit to show seriousness.', detail: 'This deposit is typically 1-2% of the purchase price.', resource: 'https://www.realtor.com' },
            { text: 'Include contingencies in your offer, such as financing and inspection.', detail: 'These protect you in case issues are found during the inspection.' },
        ]
    },
    {
        title: 'Negotiate the Offer',
        bullets: [
            { text: 'Work with your agent to determine a competitive offer price.', detail: 'Consider market conditions and recent sales in the area.', resource: 'https://www.zillow.com' },
            { text: 'Discuss negotiation strategies with your agent.', detail: 'They can advise on how to present a strong offer.' },
            { text: 'Be prepared for counteroffers from the seller.', detail: 'Negotiations may go back and forth before reaching an agreement.' },
        ]
    },
    {
        title: 'Finalize the Purchase Agreement',
        bullets: [
            { text: 'Sign the final purchase agreement once all terms are agreed upon.', detail: 'This legally binds you to the purchase and sets the closing process in motion.', resource: 'https://www.hud.gov' },
            { text: 'Submit any required documentation to your lender.', detail: 'This includes financial statements, tax returns, and employment verification.' },
            { text: 'Schedule a home appraisal to confirm the property value.', detail: 'The appraisal ensures the home is worth the agreed-upon price.' },
        ]
    },
];
...
const subStepsFive = [
    {
        ...
        bullets: [
            { text: 'Review the closing disclosure to understand costs.', detail: 'This document outlines the final terms of your loan and closing costs.', resource: 'https://www.consumerfinance.gov' },
            { text: 'Schedule a final walkthrough of the property.', detail: 'Ensure the home is in the agreed-upon condition before closing.', resource: 'https://www.realtor.com' },
            { text: 'Secure homeowners insurance and provide proof to your lender.', detail: 'This protects your investment and is required by most lenders.', resource: 'https://www.nolo.com' },
            { text: 'Prepare funds for closing costs.', detail: 'Ensure you have the down payment and any additional closing costs ready to go.', resource: 'https://www.hud.gov' },
            { text: 'Confirm with your lender that all paperwork is in order.', detail: 'This helps avoid any last-minute issues on closing day.' },
        ]
    },
    {
        title: 'Attend the Closing Meeting',
        bullets: [
            { text: 'Bring a government-issued ID and any required documents.', detail: 'This includes your down payment and closing costs.', resource: 'https://www.hud.gov' },
            { text: 'Review and sign all closing documents carefully.', detail: 'Ask questions if you do not understand any part of the paperwork.', resource: 'https://www.consumerfinance.gov' },
            { text: 'Ensure all parties are present, including your agent and lender.', detail: 'This facilitates smooth communication during the meeting.' },
    ...
    },
    {
        ...
        bullets: [
            { text: 'Plan your move and hire movers if necessary.', detail: 'Consider timing to make the transition smoother.' },
            { text: 'Set up essential services like utilities and internet.', detail: 'Do this before moving in to avoid delays.' },
            { text: 'Change the locks for security reasons.', detail: 'It’s always good to have peace of mind in a new place.' },
        ]
    },
    {
        title: 'Maintain Your Investment',
        bullets: [
            { text: 'Create a home maintenance schedule.', detail: 'Regular upkeep can prevent costly repairs down the line.', resource: 'https://www.hgtv.com' },
            { text: 'Keep track of home improvements for future resale value.', detail: 'Document renovations and upgrades you make.' },
            { text: 'Stay informed about the local market to monitor your home’s value.', detail: 'This can help you make informed decisions in the future.' },
        ]
    },
];
